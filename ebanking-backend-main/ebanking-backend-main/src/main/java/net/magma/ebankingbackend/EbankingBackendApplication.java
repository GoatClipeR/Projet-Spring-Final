package net.magma.ebankingbackend;

import net.magma.ebankingbackend.dtos.BankAccountDTO;
import net.magma.ebankingbackend.dtos.CurrentBankAccountDTO;
import net.magma.ebankingbackend.dtos.CustomerDTO;
import net.magma.ebankingbackend.dtos.SavingBankAccountDTO;
import net.magma.ebankingbackend.entities.*;
import net.magma.ebankingbackend.enums.AccountStatus;
...
import net.magma.ebankingbackend.repositories.AccountOperationRepository;
import net.magma.ebankingbackend.repositories.BankAccountRepository;
import net.magma.ebankingbackend.repositories.CustomerRepository;
import net.magma.ebankingbackend.services.BankAccountService;
